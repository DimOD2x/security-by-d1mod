...
const prefix = "PREFIX DABNE LERA";
...
const dimodcolor    = "";
const dimodimgae    = "";
const dimodban      = "";                                                                                                                                                                             const securitybots = "Anti Vandalism#6064";
const dimodwarn     = "";                                                                                                                                                                             const callidevelopers = "731952429238714378"; const calliowner = "731952429238714378";
///////////////////////////////////////////////////////////////////////////////
dimod.on("ready", () => {
...
dimod.on("message", async message => {
  if (message.content.startsWith(prefix + "invite")) {
    ...
    let help = new Discord.MessageEmbed()
      .setColor(dimodcolor)
      .setDescription(`
[Click here](https://discord.com/api/oauth2/authorize?client_id=${dimod.user.id}&permissions=8&scope=bot) **to invite the bot.**
`);
    message.channel.send(help);
  }
});
...
Enabled: ${dimodenabled}
Warn at: ${config[message.guild.id].banLimit} ${dimodwarn} 
Punish at: ${config[message.guild.id].banLimit} ${dimodban}
`
              );
        ...
        if (message.content.startsWith(prefix + "anti kick")) {
          ...
          {
            let ban = new Discord.MessageEmbed().setColor(dimodcolor)
              .setDescription(`

Anti Kick has been updated
Enabled: ${dimodenabled}
Warn at: ${config[message.guild.id].kickLimits} ${dimodwarn} 
Punish at: ${config[message.guild.id].kickLimits} ${dimodban}
...
`);
        ...
        if (message.content.startsWith(prefix + "anti roleD")) {
          ...
          {
            let roled = new Discord.MessageEmbed().setColor(dimodcolor)
              .setDescription(`
Anti Role-Delete has been updated
Enabled: ${dimodenabled}
Warn at: ${config[message.guild.id].roleDelLimit} ${dimodwarn} 
Punish at: ${config[message.guild.id].roleDelLimit} ${dimodban} `);
        ...
        if (message.content.startsWith(prefix + "anti roleC")) {
          ...
          {
            let rolec = new Discord.MessageEmbed().setColor(dimodcolor)
              .setDescription(`
Anti Role-Create has been updated
Enabled: ${dimodenabled}
Warn at: ${config[message.guild.id].roleCrLimits} ${dimodwarn} 
Punish at: ${config[message.guild.id].roleCrLimits} ${dimodban} `);
...
Enabled: ${dimodenabled}
Warn at: ${config[message.guild.id].chaDelLimit} ${dimodwarn} 
Punish at: ${config[message.guild.id].chaDelLimit} ${dimodban} `);
...
Enabled: ${dimodenabled}
Warn at: ${config[message.guild.id].chaCrLimit} ${dimodwarn} 
Punish at: ${config[message.guild.id].chaCrLimit} ${dimodban} `);
...
Enabled: ${dimodenabled}
Warn at: ${config[message.guild.id].time} ${dimodwarn} 
Punish at: ${config[message.guild.id].time} ${dimodban} `
              );
